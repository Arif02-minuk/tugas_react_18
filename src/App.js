      ...
      <>
        <div>
          ...
          >
            ...
            <SideNavItem href="#!four" waves>
              Komputer & Aksesoris
            </SideNavItem>
            <SideNavItem href="#!five" waves>
              Gaming
            </SideNavItem>
            <SideNavItem href="#!six" waves>
              Kamera
            </SideNavItem>
            <SideNavItem href="#!seven" waves>
              Olahraga
            </SideNavItem>
            <SideNavItem href="#!eight" waves>
              Fashion Pria
            </SideNavItem>
            <SideNavItem href="#!nine" waves>
              Fashion Wanita
            </SideNavItem>
          </SideNav>
        </div>
